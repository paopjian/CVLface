...
def get_sim_matrix_batch_balanced(query_feats_list, query_ids=None, num_gpus=8, 
...
# 不输出任何信息的版本
def get_sim_matrix_batch_balanced_silent(query_feats_list, query_ids=None, num_gpus=8, 
                                  block_size=2048*5, topk=None, threshold=None, 
...
def get_sim_matrix_large_scale_v3(
    query_feats_list, query_ids=None, num_gpus=8, block_size=2048*5,
    hist_bins=20_000_000, hist_range=(-1.0, 1.0),
