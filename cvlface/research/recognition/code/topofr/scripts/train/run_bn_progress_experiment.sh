...
OUTPUT_DIR="${OUTPUT_DIR:-${DATA_ROOT}/train_output/bn_progress_$(date +%Y%m%d_%H%M%S)}"

echo "TopoFR BN progress experiment"
echo "8 GPUs; one epoch; agedb_30 at 10/20/30/40/50%"
