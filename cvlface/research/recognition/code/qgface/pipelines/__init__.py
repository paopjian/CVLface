...
from .train_qgface_pipeline import TrainQGFacePipeline
...
def pipeline_from_config(pipeline_config: Union[DictConfig, dict],
                         ...
                         classifier_optimizer: Any=None,
                         model_lr_scheduler: Any=None,
                         classifier_lr_scheduler: Any=None,
                         fabric: Any=None):
    ...
    elif pipeline_config.name == 'TrainQGFacePipeline':
