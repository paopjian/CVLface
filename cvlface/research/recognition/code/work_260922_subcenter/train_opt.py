...
if __name__ == '__main__':
    ...
    improvement_monitors = [
        # work_260922_34t/tpir_at_far_1e-10: 10个epoch没有提升0.5%则早停 (mode='max', 越大越好)
        MetricImprovementMonitor(metric_name='work_260922_34t/tpir_at_far_1e-10', patience=10, min_improvement=0.005, mode='max', relative=True),
    ]
