...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_config_name', type=str, default='test_ijbc')
    parser.add_argument('--pipeline_name', type=str, default='default')
    parser.add_argument('--ckpt_dir', type=str, default="/root/zhaokj/CVLface/cvlface/pretrained_models/recognition/adaface_ir101_webface12m")
